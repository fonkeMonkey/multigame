...
/**
 * <p>This class works in conjunction with {@link NativeAppCallContentProvider}
 * to allow apps to attach binary attachments (e.g., images) to native dialogs
 ...
 * retrieve them via the content provider.</p>
 * <p/>
 * <p>Callers are generally not expected to need to use this class directly; see {@link com.facebook.widget.FacebookDialog.OpenGraphActionDialogBuilder#setImageAttachmentsForObject(String,
 * java.util.List) OpenGraphActionDialogBuilder.setImageAttachmentsForObject}
 * for an example of a function that will accept attachments, attach them to the
 * native dialog call, and add them to the content provider automatically.</p>
 */
public final class NativeAppCallAttachmentStore implements NativeAppCallContentProvider.AttachmentDataSource {
     ...
     * @param imageAttachments a Map of attachment names to Bitmaps; the
     ...
     * @param context          the Context the call is being made from
     * @param callId           the unique ID of the call
     * @param imageAttachments a Map of attachment names to Files containing the
     *                         bitmaps; the attachment names will be part of the URI processed by
     *                         openFile
     * @throws java.io.IOException
     */
