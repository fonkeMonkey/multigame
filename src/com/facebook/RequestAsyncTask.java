...
/**
 * Defines an AsyncTask suitable for executing a Request in the background. May
 * be subclassed by applications having unique threading model needs.
 */
@TargetApi(3)
public class RequestAsyncTask extends AsyncTask<Void, Void, List<Response>> {
     ...
     * background, so any serialization- related errors will be returned via the
     * Response.getException() method.
     *
    ...
    /**
     * Constructor that allows specification of an HTTP connection to use for
     * executing the requests. No validation is done that the contents of the
