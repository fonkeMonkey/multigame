...
public class SharedPreferencesTokenCachingStrategy extends TokenCachingStrategy {
  ...
  /**
   * Creates a {@link SharedPreferencesTokenCachingStrategy SharedPreferencesTokenCachingStrategy}
  ...
  private void deserializeKey(String key, Bundle bundle) throws JSONException {
    ...
    if (valueType.equals(TYPE_BOOLEAN)) {
      ...
      try {
        ...
        @SuppressWarnings({"unchecked", "rawtypes"}) Class<? extends Enum> enumClass =
            (Class<? extends Enum>) Class.forName(enumType);
        @SuppressWarnings("unchecked") Enum<?> enumValue = Enum.valueOf(enumClass, json.getString(
            JSON_VALUE));
