...
/**
 * Utility class supporting the Facebook Object. <p/> THIS CLASS SHOULD BE CONSIDERED DEPRECATED.
 * <p/> All public members of this class are intentionally deprecated. New code should instead use
 * {@link com.facebook.Request} <p/> Adding
 *
...
public final class Util {
  ...
  /**
   * Connect to an HTTP URL and return the response as a string. <p/> Note that the HTTP method
   * override is used on non-GET requests. (i.e. requests are made as "POST" with method specified
   * in the body).
   *
   ...
   * parsing. <p/> The parsed JSON is checked for a variety of error fields and a
   * FacebookException
   * is thrown if an error condition is set, populated with the error message and error type or
   * code
   * if available.
   *
  ...
  public static JSONObject parseJson(String response) throws JSONException, FacebookError {
    ...
    if (json.has("error_code") && json.has("error_msg")) {
      throw new FacebookError(json.getString("error_msg"), "", Integer.parseInt(json.getString(
          "error_code")));
    }
