...
public class Facebook {
     ...
     * be null only if the user has not installed or logged in to the Facebook
     * app.
     */
    @Deprecated
     ...
     * @param permissions  A list of permissions required for this application:
     *                     e.g. "read_stream", "publish_stream", "offline_access", etc. see
     *                     http://developers.facebook.com/docs/authentication/permissions This
     *                     parameter should not be null -- if you do not require any permissions,
     *                     then pass in an empty String array.
     * @param activityCode Single sign-on requires an activity result to be
     *                     called back to the client application -- if you are waiting on other
     *                     activities to return data, pass a custom activity code here to avoid
     *                     collisions. If you would like to force the use of legacy dialog-based
     *                     authorization, pass FORCE_DIALOG_AUTH for this parameter. Otherwise just
     *                     omit this parameter and Facebook will use a suitable default. See
     *                     http://developer.android.com/reference/android/ app/Activity.html for
     *                     more information.
     * @param listener     Callback interface for notifying the calling application
     *                     when the authentication dialog has completed, failed, or been canceled.
     */
    @Deprecated
     ...
     *                     http://developer.android.com/reference/android/ app/Activity.html for
     *                     more information.
     * @param behavior     The {@link SessionLoginBehavior SessionLoginBehavior}
     *                     that specifies what behaviors should be attempted during authorization.
     * @param listener     Callback interface for notifying the calling application
     *                     when the authentication dialog has completed, failed, or been canceled.
     */
     ...
     * more info.
     *
     * @param context         The Android Context that will be used to bind to the
     *                        Facebook RefreshToken Service
     * @param serviceListener Callback interface for notifying the calling
     *                        application when the refresh request has completed or failed (can be
     *                        null). In case of a success a new token can be found inside the result
     ...
     *                   parameters {"q" : "facebook"} would produce a query for the following
     *                   graph resource: https://graph.facebook.com/search?q=facebook
     ...
     * more info.
     *
     * @param expiresInSecsFromNow - duration in seconds (or 0 if the session
     *                             doesn't expire)
     */
    @Deprecated
     ...
     * more info.
     *
     * @param value a Boolean indicating whether installation of the app should
     *              be auto-published.
     */
    @Deprecated
     ...
     * no longer necessary to call. Apps should ignore this value, but for
     * compatibility we will return false to ensure repeat calls (and the
     ...
     * Adding
     *
     * @Deprecated to this class causes warnings in other deprecated classes
