...
public class AppEventsConstants {
  ...
  // Ecommerce related
  /**
   * Log this event when the user has added an item to their cart. The valueToSum passed to
   * logEvent
   ...
   * AppEventsLogger#logPurchase(java.math.BigDecimal, java.util.Currency)} method is a shortcut for
   * logging this event.
   */
   ...
   * ISO-4217 for specific values. One reference for these is <http://en.wikipedia
   * .org/wiki/ISO_4217>.
   */
  public static final String EVENT_PARAM_CURRENCY = "fb_currency";
  /**
   * Parameter key used to specify method user has used to register for the app, e.g., "Facebook",
   * "email", "Twitter", etc.
   */
   ...
   * e.g. "music",
   * "photo", "video". Options to use will vary based upon what the app is all about.
   */
  public static final String EVENT_PARAM_CONTENT_TYPE = "fb_content_type";
  /**
   * Parameter key used to specify an ID for the specific piece of content being logged about. Could
   * be an EAN, article identifier, etc., depending on the nature of the app.
   */
