 ...
 * Logging occurs through the
 * {@link AppEventsLogger#logEvent(String, android.os.Bundle)} family of
 * methods.
 *
 * @beta
 */
public class AppEventsConstants {
     ...
     * {@link AppEventsLogger#logPurchase(java.math.BigDecimal, java.util.Currency)}
     * method is a shortcut for logging this event.
     */
     ...
     * "USD", "EUR", "GBP". See ISO-4217 for specific values. One reference for
    ...
    /**
     * Parameter key used to specify a generic content type/family for the
     * logged event, e.g. "music", "photo", "video". Options to use will vary
     * based upon what the app is all about.
     */
    ...
    /**
     * Parameter key used to specify the string provided by the user for a
     * search operation.
     */
     ...
     * successful or not. EVENT_PARAM_VALUE_YES and EVENT_PARAM_VALUE_NO are
     ...
     * EVENT_NAME_RATE event. E.g., "5" or "10".
     */
     ...
     * EVENT_NAME_INITIATED_CHECKOUT event. EVENT_PARAM_VALUE_YES and
     * EVENT_PARAM_VALUE_NO are good canonical values to use for this parameter.
     */
    ...
    /**
     * Parameter key used to specify the level achieved in a
     * EVENT_NAME_LEVEL_ACHIEVED event.
     */
    public static final String EVENT_PARAM_LEVEL = "fb_level";
    /**
     * Parameter key used to specify a description appropriate to the event
     * being logged. E.g., the name of the achievement unlocked in the
     * EVENT_NAME_ACHIEVEMENT_UNLOCKED event.
     */
    public static final String EVENT_PARAM_DESCRIPTION = "fb_description";
    // Parameter values
    /**
     * Yes-valued parameter value to be used with parameter keys that need a
     * Yes/No value
     */
    public static final String EVENT_PARAM_VALUE_YES = "1";
    /**
     * No-valued parameter value to be used with parameter keys that need a
     * Yes/No value
     */
