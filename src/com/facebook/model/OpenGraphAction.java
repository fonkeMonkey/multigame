...
/**
 * Provides a strongly-typed representation of an Open Graph Action. For more documentation of OG
 * Actions, see: https://developers.facebook.com/docs/opengraph/actions/ <p/> Note that this
 * interface is intended to be used with GraphObject.Factory or OpenGraphAction.Factory and not
...
public interface OpenGraphAction extends GraphObject {
  ...
  /**
   * Gets the unique string which will be passed to the OG Action owner's website when a user
   * clicks
   * through this action on Facebook.
   *
  ...
  /**
   * Sets the unique string which will be passed to the OG Action owner's website when a user
   * clicks
   * through this action on Facebook.
   *
   ...
   * helper that will create GraphObjects with the correct URLs and populate the property with
   * those
   * objects.
   *
   * @param urls the URLs
  ...
  /**
   * Gets the type-specific data for this action; for instance, any properties referencing Open
   * Graph objects will appear under here.
   *
   ...
   * href="https://developers.facebook.com/docs/opengraph/guides/explicit-sharing/">Explicit
   * Sharing</a> for more information.
   *
   ...
   * href="https://developers.facebook.com/docs/opengraph/guides/explicit-sharing/">Explicit
   * Sharing</a> for more information. You should only specify this property if explicit sharing has
   * been enabled for an Open Graph action type.
   *
