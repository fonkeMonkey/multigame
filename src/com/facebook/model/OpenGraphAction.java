...
public interface OpenGraphAction extends GraphObject {
    ...
    /**
     * Gets the type of the action, which is a string in the form
     * "mynamespace:mytype".
     *
     * @return the type
     */
    ...
    /**
     * Sets the type of the action, which is a string in the form
     * "mynamespace:mytype".
     *
     * @param type the type
     */
    ...
    /**
     * Gets the unique string which will be passed to the OG Action owner's
     * website when a user clicks through this action on Facebook.
     *
    ...
    /**
     * Sets the unique string which will be passed to the OG Action owner's
     * website when a user clicks through this action on Facebook.
     *
    ...
    /**
     * Sets the images associated with the Open Graph action by specifying their
     ...
     * href="https://developers.facebook.com/docs/opengraph/guides/explicit-sharing/">Explicit
     * Sharing</a> for more information. You should only specify this property
     * if explicit sharing has been enabled for an Open Graph action type.
     *
