...
/**
 * Provides a strongly-typed representation of an Open Graph Object. For more documentation of OG
 * Objects, see: https://developers.facebook.com/docs/opengraph/using-object-api/ <p/> Note that
 * this interface is intended to be used with GraphObject.Factory or OpenGraphObject.Factory and not
...
public interface OpenGraphObject extends GraphObject {
   ...
   * helper that will create GraphObjects with the correct URLs and populate the property with those
   * objects.
   *
   * @param urls the URLs
   */
  ...
  /**
   * Gets the "determiner" for the Open Graph object. This is the word such as "a", "an", or "the"
   * that will appear before the title of the object.
   *
  ...
  /**
   * Sets the "determiner" for the Open Graph object. This is the word such as "a", "an", or "the"
   * that will appear before the title of the object.
   *
   ...
   * if it is a
   * user-owned object, otherwise null. The post action controls the privacy of this object.
   *
   ...
   * that
   * are defined on an application-defined Open Graph object type will appear here.
   *
  ...
  /**
   * Gets whether the object represents a new object that should be created as part of publishing
   * via, e.g., the native Share dialog. This flag has no effect on explicit publishing of an
   * action
   * via, e.g., a POST to the '/me/objects/object_type' endpoint.
   *
  ...
  /**
   * Sets whether the object represents a new object that should be created as part of publishing
   * via, e.g., the native Share dialog. This flag has no effect on explicit publishing of an
   * action
   * via, e.g., a POST to the '/me/objects/object_type' endpoint.
   *
   * @param createObject true if the native Share dialog should create the object as part of
   * publishing an action, false if not
   */
  @PropertyName(NativeProtocol.OPEN_GRAPH_CREATE_OBJECT_KEY)
  ...
  final class Factory {
    ...
    /**
     * Creates an OpenGraphObject suitable for posting via, e.g., a native Share dialog. The object
     * will have no properties other than a 'create_object' and 'data' property, ready to be
     * populated.
     *
     ...
     * a native Share dialog. The object
     * will have the specified properties, plus a 'create_object' and 'data' property,
     * ready to be
     * populated.
     *
     * @param graphObjectClass the OpenGraphObject-derived type to return
     ...
     */
    public static <T extends OpenGraphObject> T createForPost(Class<T> graphObjectClass,
        String type, String title, String imageUrl, String url, String description) {
