...
public interface OpenGraphObject extends GraphObject {
    ...
    /**
     * Gets the type of the object, which is a string in the form
     * "mynamespace:mytype".
     *
     * @return the type
     */
    ...
    /**
     * Sets the type of the object, which is a string in the form
     * "mynamespace:mytype".
     *
     * @param type the type
     */
    ...
    /**
     * Sets the images associated with the Open Graph object by specifying their
     * URLs. This is a helper that will create GraphObjects with the correct
     * URLs and populate the property with those objects.
     *
     * @param urls the URLs
     */
    ...
    /**
     * Gets the "determiner" for the Open Graph object. This is the word such as
     * "a", "an", or "the" that will appear before the title of the object.
     *
    ...
    /**
     * Sets the "determiner" for the Open Graph object. This is the word such as
     * "a", "an", or "the" that will appear before the title of the object.
     *
    ...
    /**
     * Gets whether the Open Graph object was created by scraping a Web resource
     * or not.
     *
     * @return true if the Open Graph object was created by scraping the Web,
     * false if not
     */
    boolean getIsScraped();

    /**
     * Sets whether the Open Graph object was created by scraping a Web resource
     * or not.
     *
    ...
    /**
     * Gets the Open Graph action which was created when this Open Graph action
     * was posted, if it is a user-owned object, otherwise null. The post action
     * controls the privacy of this object.
     *
    ...
    /**
     * Sets the Open Graph action which was created when this Open Graph action
     * was posted, if it is a user-owned object, otherwise null. The post action
     * controls the privacy of this object.
     *
    ...
    /**
     * Gets the type-specific properties of the Open Graph object, if any. Any
     * custom properties that are defined on an application-defined Open Graph
     * object type will appear here.
     *
    ...
    /**
     * Sets the type-specific properties of the Open Graph object, if any. Any
     * custom properties that are defined on an application-defined Open Graph
     * object type will appear here.
     *
    ...
    /**
     * Gets whether the object represents a new object that should be created as
     * part of publishing via, e.g., the native Share dialog. This flag has no
     * effect on explicit publishing of an action via, e.g., a POST to the
     * '/me/objects/object_type' endpoint.
     *
     * @return true if the native Share dialog should create the object as part
     * of publishing an action, false if not
     */
    @PropertyName(NativeProtocol.OPEN_GRAPH_CREATE_OBJECT_KEY)
    boolean getCreateObject();

    /**
     * Sets whether the object represents a new object that should be created as
     * part of publishing via, e.g., the native Share dialog. This flag has no
     * effect on explicit publishing of an action via, e.g., a POST to the
     * '/me/objects/object_type' endpoint.
     *
    ...
    final class Factory {
        ...
        /**
         * Creates an OpenGraphObject suitable for posting via, e.g., a native
         * Share dialog. The object will have no properties other than a
        ...
        /**
         * Creates an OpenGraphObject suitable for posting via, e.g., a native
         * Share dialog. The object will have the specified properties, plus a
         * 'create_object' and 'data' property, ready to be populated.
         *
         * @param graphObjectClass the OpenGraphObject-derived type to return
         * @param type the Open Graph object type for the object, or null if it
