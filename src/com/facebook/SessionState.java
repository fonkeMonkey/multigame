...
/**
 * <p> Identifies the state of a Session. </p> <p> Session objects implement a
 * state machine that controls their lifecycle. This enum represents the states
...
public enum SessionState {
    ...
    /**
     * <p> Indicates that the Session has not yet been opened and has a cached
     * token. Opening a Session in this state will not involve user interaction.
     * </p> <p> If you are using Session from an Android Service, you must
     * provide a TokenCachingStrategy implementation that contains a valid token
     * to the Session constructor. The resulting Session will be created in this
     * state, and you can then safely call open, passing null for the Activity.
     * </p>
     */
    ...
    /**
     * <p> Indicates that the Session is opened and that the token has changed.
     * In this state, the Session may be used with {@link Request}. </p> <p>
     * Every time the token is updated, {@link Session.StatusCallback
     * StatusCallback} is called with this value. </p>
     */
