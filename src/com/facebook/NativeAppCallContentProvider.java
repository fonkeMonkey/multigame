...
/**
 * <p>Implements a <a
 * href="http://developer.android.com/reference/android/content/ContentProvider.html">
 * ContentProvider</a> that can be used to provide binary attachments (e.g.,
 ...
 * <code>"com.facebook.app.NativeAppCallContentProvider{FACEBOOK_APP_ID}"</code>.
 * See the
 * {@link NativeAppCallContentProvider#getAttachmentUrl(String) getContentProviderName}
 * method.</p>
 */
public class NativeAppCallContentProvider extends ContentProvider {
    ...
    /**
     * Returns the name of the content provider formatted correctly for
     * constructing URLs.
     *
