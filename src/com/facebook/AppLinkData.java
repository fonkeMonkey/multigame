...
/**
 * Class to encapsulate an app link, and provide methods for constructing the
 * data from various sources
 */
public class AppLinkData {

    /**
     * Key that should be used to pull out the UTC Unix tap-time from the
     * arguments for this app link.
     */
    ...
    /**
     * The full set of arguments for this app link. Properties like TargetUri &
     * Ref are typically picked out of this set of arguments.
     *
    ...
    /**
     * Interface to asynchronously receive AppLinkData after it has been
     * fetched.
     */
