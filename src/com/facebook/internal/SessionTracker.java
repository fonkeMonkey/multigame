...
public class SessionTracker {
  ...
  /**
   * Constructs a SessionTracker to track the Session object passed in. If the Session is null,
   * then
   * it will track the active Session instead.
   *
   * @param context the context object.
  ...
  /**
   * The BroadcastReceiver implementation that either adds or removes the callback from the active
   * Session object as it's SET or UNSET.
   */
