...
public final class Utility {
  ...
  private static final String[] APP_SETTING_FIELDS =
      new String[]{SUPPORTS_ATTRIBUTION, SUPPORTS_IMPLICIT_SDK_LOGGING};
  ...
  public static Object getStringPropertyAsJSON(JSONObject jsonObject, String key,
      String nonJSONPropertyKey) throws JSONException {
  ...
  public static void clearFacebookCookies(Context context) {
    ...
    // are using
    // Chromium HTTP stack and those that are not. Using both of these domains to ensure it works
    // on both.
  ...
  public static FetchedAppSettings queryAppSettings(final String applicationId,
    ...
    FetchedAppSettings result = new FetchedAppSettings(safeGetBooleanFromResponse(supportResponse,
        SUPPORTS_ATTRIBUTION), safeGetBooleanFromResponse(supportResponse,
