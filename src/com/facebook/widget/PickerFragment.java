...
/**
 * Provides functionality common to SDK UI elements that allow the user to pick
 * one or more graph objects (e.g., places, friends) from a list of
 * possibilities. The UI is exposed as a Fragment to allow to it to be included
 * in an Activity along with other Fragments. The Fragments can be configured by
 * passing parameters as part of their Intent bundle, or (for certain
 * properties) by specifying attributes in their XML layout files. <br/>
 * PickerFragments support callbacks that will be called in the event of an
 * error, when the underlying data has been changed, or when the set of selected
 * graph objects changes.
 */
public abstract class PickerFragment<T extends GraphObject> extends Fragment {

    /**
     * The key for a boolean parameter in the fragment's Intent bundle to
     * indicate whether the picker should show pictures (if available) for the
     * graph objects.
     */
    public static final String SHOW_PICTURES_BUNDLE_KEY = "com.facebook.widget.PickerFragment.ShowPictures";
    /**
     * The key for a String parameter in the fragment's Intent bundle to
     * indicate which extra fields beyond the default fields should be retrieved
     * for any graph objects in the results.
     */
    public static final String EXTRA_FIELDS_BUNDLE_KEY = "com.facebook.widget.PickerFragment.ExtraFields";
    /**
     * The key for a boolean parameter in the fragment's Intent bundle to
     * indicate whether the picker should display a title bar with a Done
     * button.
     */
    public static final String SHOW_TITLE_BAR_BUNDLE_KEY = "com.facebook.widget.PickerFragment.ShowTitleBar";
    /**
     * The key for a String parameter in the fragment's Intent bundle to
     * indicate the text to display in the title bar.
     */
    public static final String TITLE_TEXT_BUNDLE_KEY = "com.facebook.widget.PickerFragment.TitleText";
    /**
     * The key for a String parameter in the fragment's Intent bundle to
     * indicate the text to display in the Done btuton.
     */
    ...
    /**
     * Gets the current OnDataChangedListener for this fragment, which will be
     * called whenever the underlying data being displaying in the picker has
     * changed.
     *
    ...
    /**
     * Sets the current OnDataChangedListener for this fragment, which will be
     * called whenever the underlying data being displaying in the picker has
     * changed.
     *
    ...
    /**
     * Gets the current OnSelectionChangedListener for this fragment, which will
     * be called whenever the user selects or unselects a graph object in the
     * list.
     *
    ...
    /**
     * Sets the current OnSelectionChangedListener for this fragment, which will
     * be called whenever the user selects or unselects a graph object in the
     * list.
     *
    ...
    /**
     * Gets the current OnDoneButtonClickedListener for this fragment, which
     * will be called when the user clicks the Done button.
     *
    ...
    /**
     * Sets the current OnDoneButtonClickedListener for this fragment, which
     * will be called when the user clicks the Done button. This will only be
    ...
    /**
     * Gets the current OnErrorListener for this fragment, which will be called
     * in the event of network or other errors encountered while populating the
     * graph objects in the list.
     *
    ...
    /**
     * Sets the current OnErrorListener for this fragment, which will be called
     * in the event of network or other errors encountered while populating the
     * graph objects in the list.
     *
     ...
     * graph object returned from the service to determine if it should be
     * displayed in the list. If no filter is specified, all retrieved graph
    ...
    /**
     * Sets the current filter for this fragment, which will be called for each
     * graph object returned from the service to determine if it should be
     * displayed in the list. If no filter is specified, all retrieved graph
     * objects will be displayed.
     *
    ...
    /**
     * Gets the Session to use for any Facebook requests this fragment will
     * make.
     *
     * @return the Session that will be used for any Facebook requests, or null
     * if there is none
     */
    ...
    /**
     * Sets the Session to use for any Facebook requests this fragment will
     * make. If the parameter is null, the fragment will use the current active
     * session, if any.
     *
    ...
    /**
     * Gets whether to display pictures, if available, for displayed graph
     * objects.
     *
    ...
    /**
     * Sets whether to display pictures, if available, for displayed graph
     * objects.
     *
    ...
    /**
     * Updates the properties of the PickerFragment based on the contents of the
     * supplied Bundle; calling Activities may use this to pass additional
     * configuration information to the PickerFragment beyond what is specified
     * in its XML layout.
     *
     ...
     * encountered while retrieving graph objects.
     */
    ...
    /**
     * Callback interface that will be called when the underlying data being
     * displayed in the picker has been updated.
     */
    public interface OnDataChangedListener {

        /**
         * Called when the set of data being displayed in the picker has
         * changed.
         */
    ...
    /**
     * Callback interface that will be called when the user selects or unselects
     * graph objects in the picker.
     */
    public interface OnSelectionChangedListener {

        /**
         * Called when the user selects or unselects graph objects in the
         * picker.
         */
    ...
    /**
     * Callback interface that will be called when the user clicks the Done
    ...
    /**
     * Callback interface that will be called to determine if a graph object
     * should be displayed.
     *
     * @param <T>
     */
