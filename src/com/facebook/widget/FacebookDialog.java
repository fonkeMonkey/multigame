...
public class FacebookDialog {
     ...
     * added, these flags may be passed to null     {@link FacebookDialog#canPresentShareDialog(android.content.Context,
     * com.facebook.widget.FacebookDialog.ShareDialogFeature...)} to determine
     * whether the version of the Facebook application installed on the user's
     * device is recent enough to support specific features, which in turn may
     * be used to determine which UI, etc., to present to the user.
     */
     ...
     * action dialog exposed by the Facebook application. As additional features
     * are added, these flags may be passed to null     {@link FacebookDialog#canPresentOpenGraphActionDialog(android.content.Context,
     * com.facebook.widget.FacebookDialog.OpenGraphActionDialogFeature...)} to
     * determine whether the version of the Facebook application installed on
     ...
     * be used if {@link FacebookDialog.checkCanPresentShareDialog()} indicates
     ...
     * {@link FacebookDialog.checkCanPresentOpenGraphDialog();} indicates the
    ...
    public static class OpenGraphActionDialogBuilder extends Builder<OpenGraphActionDialogBuilder> {
        ...
        /**
         * <p>Specifies a list of images for the Open Graph action that should
         * be uploaded prior to publishing the action. The action must already
         * have been set prior to calling this method. This method will generate
         ...
         * <p>Specifies a list of images for the Open Graph action that should
         * be uploaded prior to publishing the action. The action must already
         * have been set prior to calling this method. The images will not be
         * marked as being user-generated. This method will generate unique
         * names for the image attachments and update the action to refer to
         ...
         * <p>Specifies a list of images for the Open Graph action that should
         * be uploaded prior to publishing the action. The action must already
         * have been set prior to calling this method. The images may be marked
         * as being user-generated -- refer to <a
         * href="https://developers.facebook.com/docs/opengraph/howtos/adding-photos-to-stories/">this
         * article</a> for more information. This method will generate unique
         * names for the image attachments and update the action to refer to
         * these attachments. Note that calling setAction again after calling
         * this method will not clear the image attachments already set, but the
         * new action will have no reference to the existing attachments.</p>
        ...
        /**
         * <p>Specifies a list of images for an Open Graph object referenced by
         * the action that should be uploaded prior to publishing the action.
         * The images will not be marked as user-generated. The action must
         * already have been set prior to calling this method, and the action
         * must have a GraphObject-valued property with the specified property
         * name. This method will generate unique names for the image
         * attachments and update the graph object to refer to these
         * attachments. Note that calling setObject again after calling this
         ...
         * href="https://developers.facebook.com/docs/opengraph/howtos/adding-photos-to-stories/">this
         * article</a> for more information. The action must already have been
         * set prior to calling this method, and the action must have a
