 ...
 * conforming to user specified dimensions.
 */
public class ProfilePictureView extends FrameLayout {
    ...
    /**
     * Indicates that the specific size of the View will be set via layout
     * params. ProfilePictureView will default to NORMAL X NORMAL, if the layout
     * params set on this instance do not have a fixed size. Used in calls to
     * setPresetSize() and getPresetSize(). Corresponds with the preset_size Xml
     ...
     * in calls to setPresetSize() and getPresetSize(). Corresponds with the
     * preset_size Xml attribute that can be set on ProfilePictureView.
     */
    public static final int SMALL = -2;
    /**
     * Indicates that the profile image should fit in a NORMAL X NORMAL space,
     * regardless of whether the cropped or un-cropped version is chosen. Used
     * in calls to setPresetSize() and getPresetSize(). Corresponds with the
     * preset_size Xml attribute that can be set on ProfilePictureView.
     */
    ...
    /**
     * Indicates that the profile image should fit in a LARGE X LARGE space,
     * regardless of whether the cropped or un-cropped version is chosen. Used
     * in calls to setPresetSize() and getPresetSize(). Corresponds with the
     * preset_size Xml attribute that can be set on ProfilePictureView.
     */
    ...
    /**
     * Indicates whether the cropped version of the profile photo has been
     * chosen
     *
    ...
    /**
     * Sets an OnErrorListener for this instance of ProfilePictureView to call
    ...
    /**
     * The ProfilePictureView will display the provided image while the
     * specified profile is being loaded, or if the specified profile is not
     * available.
     *
     ...
     * specified in the layout. Since we don't know the dimensions of the
     * profile photo, we need to handle this case specifically.
     * <p/>
     * The approach is to default to a NORMAL sized amount of space in the case
     * that a preset size is not specified. This logic is applied to both width
     * and height
     */
    @Override
    ...
    /**
     * In addition to calling super.Layout(), we also attempt to get a new image
     * that is properly size for the layout dimensions
     */
    @Override
    ...
    /**
     * Some of the current state is returned as a Bundle to allow quick
     * restoration of the ProfilePictureView object in scenarios like
     * orientation changes.
     *
    ...
    /**
     * If the passed in state is a Bundle, an attempt is made to restore from
     * it.
     *
