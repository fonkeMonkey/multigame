...
/**
 * Provides a Fragment that displays a list of a user's friends and allows one
 * or more of the friends to be selected.
 */
public class FriendPickerFragment extends PickerFragment<GraphUser> {
     ...
     * indicate what user's friends should be shown. The default is to display
     * the currently authenticated user's friends.
     */
     ...
     * indicate whether the picker should allow more than one friend to be
     * selected or not.
     */
    ...
    /**
     * Gets the ID of the user whose friends should be displayed. If null, the
     * default is to show the currently authenticated user's friends.
     *
    ...
    /**
     * Sets the ID of the user whose friends should be displayed. If null, the
     * default is to show the currently authenticated user's friends.
     *
     ...
     *
     * @return true if the user can select multiple friends, false if only one
     * friend
     */
