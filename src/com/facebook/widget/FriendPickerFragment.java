...
public class FriendPickerFragment extends PickerFragment<GraphUser> {
   ...
   * picker
   * should allow more than one friend to be selected or not.
   */
  ...
  /**
   * Gets the ID of the user whose friends should be displayed. If null,
   * the default is to show the
   * currently authenticated user's friends.
   *
  ...
  /**
   * Sets the ID of the user whose friends should be displayed. If null,
   * the default is to show the
   * currently authenticated user's friends.
   *
