...
public class PlacePickerFragment extends PickerFragment<GraphPlace> {
    ...
    /**
     * The key for an int parameter in the fragment's Intent bundle to indicate
     * the radius in meters around the center point to search. The default is
     * 1000 meters.
     */
    public static final String RADIUS_IN_METERS_BUNDLE_KEY = "com.facebook.widget.PlacePickerFragment.RadiusInMeters";
    /**
     * The key for an int parameter in the fragment's Intent bundle to indicate
     * what how many results to return at a time. The default is 100 results.
     */
     ...
     * indicate what search text should be sent to the service. The default is
     * to have no search text.
     */
    public static final String SEARCH_TEXT_BUNDLE_KEY = "com.facebook.widget.PlacePickerFragment.SearchText";
    /**
     * The key for a Location parameter in the fragment's Intent bundle to
     * indicate what geographical location should be the center of the search.
     */
     ...
     * indicate that the fragment should display a search box and automatically
     * update the search text as it changes.
     */
    ...
    /**
     * Gets the location to search around. Either the location or the search
    ...
    /**
     * Sets the location to search around. Either the location or the search
     * text (or both) must be specified.
     *
    ...
    /**
     * Gets the search text (e.g., category, name) to search for. Either the
     * location or the search text (or both) must be specified.
     *
    ...
    /**
     * Sets the search text (e.g., category, name) to search for. Either the
     * location or the search text (or both) must be specified. If a search box
     * is displayed, this will update its contents to the specified text.
     *
    ...
    /**
     * Sets the search text and reloads the data in the control. This is used to
     * provide search-box functionality where the user may be typing or editing
     * text rapidly. It uses a timer to avoid repeated requerying, preferring to
     * wait until the user pauses typing to refresh the data. Note that this
     * method will NOT update the text in the search box, if any, as it is
     * intended to be called as a result of changes to the search box (and is
