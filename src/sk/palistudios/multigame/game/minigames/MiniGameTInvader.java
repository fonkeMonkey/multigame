...
//        drawMinigame(canvas);
    ...
    public void initMinigame(Bitmap mBitmap, boolean wasGameSaved) {
        ...
        if (!wasGameSaved) {
            mPointSmallerCircle = new PointSerializable(mPointMiddleOfScreen.mPoint.x / 2, mPointMiddleOfScreen.mPoint.y / 2);
        }
...
//        difficultyStep = 8;
    ...
    public void drawMinigame(Canvas mCanvas) {
        mCanvas.drawCircle(mPointMiddleOfScreen.mPoint.x, mPointMiddleOfScreen.mPoint.y, mCenterCircleSize, mPaintMiddleCircle.mPaint);
        mCanvas.drawCircle(mPointSmallerCircle.mPoint.x, mPointSmallerCircle.mPoint.y, mSmallCircleSize, mPaintSmallCircle.mPaint);
    ...
    private void setRectangleCoordinates(PointSerializable mPointMiddleOfScreen, PointSerializable mPointSmallerCircle) {
