...
public class PremiumUpgrader {
  ...
  public static void upgrade(final Activity act) {
    String string3 =
        "GD3OkFInTRfMUHBvZOgNAX/dEqX5Zb3iLSkPqXSkeVXDtzOaDEw9SiwYWOtFay" +
            "/ZZbcfhna3YucSF1v79TW6TvV22AhbkeM/2fUTlwf1zB9KX23/42tg++/PJuBxEBWNbiuCog";
    ...
    String string4 =
        "csKFHQqhMXDt4H/5ibuXpyz0CntrUHwHcaC2JsCqJrK8o5PoOb08wM4yeoBxI8LLrF9zS03OCtAVy8n6Nw" +
            "+hI0syCbGJlbbCYcEU0wk8466oPhRca4vyyK95pWk2+mwwIDAQAB";
  ...
  public static void onUpgradeAppButtonClicked(View arg0) {
    ...
    mHelper.launchPurchaseFlow(mAct, SKU_PREMIUM, RC_REQUEST, mPurchaseFinishedListener, payload);
  }
  //    // Called when consumption is complete
  //    static IabHelper.OnConsumeFinishedListener mConsumeFinishedListener = new IabHelper
