...
public class AchievementsCenterListActivity extends BaseListActivity {
  ...
  public static void initAchievements(Context context) {
    ...
    if (achievements.isEmpty()) {
      achievements.add(new AchievementItem("good_start", (String) context.getResources().getString(
      ...
      achievements.add(new AchievementItem("lucky_seven", (String) context.getResources().getString(
          R.string.cc_achievements_lucky_seven_name), (String) context.getResources().getString(
      ...
      achievements.add(new AchievementItem("magic_ten", (String) context.getResources().getString(
      ...
      achievements.add(new AchievementItem("addict", (String) context.getResources().getString(
      ...
      achievements.add(new AchievementItem("supporter", (String) context.getResources().getString(
      ...
      achievements.add(new AchievementItem("competitive", (String) context.getResources().getString(
          R.string.cc_achievements_competitive_name), (String) context.getResources().getString(
      ...
      achievements.add(new AchievementItem("champion", (String) context.getResources().getString(
