...
public class MinigamesCenterListActivity extends BaseListActivity {
    ...
    getListView().setOnItemClickListener(new AdapterView.OnItemClickListener() {
      ...
      public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        ...
        if (minigamesAdapter.getItem(position - 1).isLocked()) {
          Toaster.toastLong(minigamesAdapter.getItem(position - 1).getLockedDescription(),
              getParent());
          return;
        }
  ...
  public void initAdapter() {
    ...
    items.add(new MgcItem(SYMBOL_MINIGAME_HORIZONTAL, "HBalance", "Balance",
        GameSharedPref.isMinigameChosen("HBalance")));
    items.add(new MgcItem(SYMBOL_MINIGAME_TOUCH, "TCatcher", "Catcher",
        GameSharedPref.isMinigameChosen("TCatcher")));
    items.add(new MgcItem(SYMBOL_MINIGAME_TOUCH, "TGatherer", "Gatherer",
        GameSharedPref.isMinigameChosen("TGatherer")));
    items.add(new MgcItem(SYMBOL_MINIGAME_TOUCH, "TInvader", "Invader",
    ...
    items.add(new MgcItem(SYMBOL_MINIGAME_VERTICAL, "VBird", "Bird",
        GameSharedPref.isMinigameChosen("VBird")));
    items.add(new MgcItem(SYMBOL_MINIGAME_VERTICAL, "VBouncer", "Bouncer",
    ...
    minigamesAdapter = new MgcArrayAdapter(this, items, SkinsCenterListActivity.getCurrentSkin(
        this));
  }
